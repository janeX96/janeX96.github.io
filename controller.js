const addresses = [
  ...
  "Rue de Betzdorf, Olingen Betzdorf, Luksemburg",
  " 8 Rue de Boursdorf, Dickweiler Rosport-Mompach, Luksemburg",
  "88 Route du Vin, Schwebsange Schengen, Luksemburg",
  "10 Rue Albert Simon, Contern, Luksemburg",
  "5 Im Reder, Greiveldange Stadtbredimus, Luksemburg",
  // "66 Hiehl, Uewerwuermeldeng Wuermeldeng, Luksemburg",
  // "12 Rue John L Macadam, Cents Luksemburg",
  // "30 ZI, Kehlen, Luksemburg",
  // "Z.A.C. Haneboesch II, Differdange, Luksemburg",
  "3 Rue Geespelt, Livange Roeser, Luksemburg",
];
